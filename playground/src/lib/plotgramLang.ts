...
export function plotgramCompletions(context: CompletionContext): CompletionResult | null {
...
function unifiedCompletions(context: CompletionContext): CompletionResult | null {
  return contextAwareCompletions(context) ?? plotgramCompletions(context);
}

export function plotgram(): LanguageSupport {
  return new LanguageSupport(plotgramStreamLanguage, [
    diagramContextField,
    plotgramStreamLanguage.data.of({ autocomplete: unifiedCompletions }),
  ]);
}
