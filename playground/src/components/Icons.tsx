...
export function IconGallery({ size = 16, className }: IconProps) {
  return (
...
export function IconFolderOpen({ size = 16, className }: IconProps) {
  return (
    <svg {...svgProps(size)} className={className}>
      <path d="M5 19a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4l2 2h6a2 2 0 0 1 2 2v1" />
      <path d="M2 10h16a2 2 0 0 1 2 2l-2 7H4l-2-7a2 2 0 0 1 2-2Z" />
    </svg>
  );
}
...
export function IconCommandPalette({ size = 16, className }: IconProps) {
  return (
    <svg {...svgProps(size)} className={className}>
      <circle cx="11" cy="11" r="8" />
      <line x1="21" y1="21" x2="16.65" y2="16.65" />
