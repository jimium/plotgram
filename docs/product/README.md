...
| 文档 | 内容 |
|------|------|
| [vision.md](vision.md) | 项目愿景与定位 |
| [features.md](features.md) | 功能特性设计 |
| [use-cases.md](use-cases.md) | 使用场景与案例 |
| [connector-ast-scenarios.md](connector-ast-scenarios.md) | Connector → AST → Web 渲染的高价值场景分析 |
