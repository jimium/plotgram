...
| **Plotgram** | AI Agent 原生图表语言 | 2025 | 声明式 DSL |
...
这是 Plotgram 最核心的差异化维度。

| 维度 | Mermaid | PlantUML | Graphviz DOT | Plotgram |
|------|---------|----------|--------------|--------|
...
| 维度 | Mermaid | PlantUML | Graphviz DOT | Plotgram (目标) |
|------|---------|----------|--------------|---------------|
| AI 生成友好度 | ★★★ | ★★ | ★ | ★★★★★ |
| 语法简洁度 | ★★★ | ★★ | ★★ | ★★★★★ |
| 错误处理 | ★ | ★ | ★★ | ★★★★★ |
...
### Plotgram 不是 Mermaid 的竞品

Mermaid 解决的问题是"让人类能用文本画图"。它在这个定位上做得很好。

Plotgram 解决的问题是"让 AI Agent 能可靠地生成图表"。这是一个**全新**的问题，现有工具从设计之初就没有考虑过。
