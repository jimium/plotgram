...
本目录存放 Plotgram 面向企业客户（含国内银行/互联网与国际市场）的场景分析、能力规划与 POC 设计文档。
...
| [K8s 可视化行业现状](./k8s-visualization-landscape.md) | Plotgram 出现前的业界解法、痛点对比、客户话术 | draft |
...
- `international-compliance-mapping.md` — SOC2 / GDPR / HIPAA 与 Plotgram 能力映射（英文白皮书）
