...
- [Cytoscape.js 能力研究](./cytoscape-js-research.md) - Cytoscape.js 布局与图论算法分析及 Plotgram 取舍
...
- [Core 重构方案](./plotgram-core-refactor-plan.md) - `plotgram-core` 模块与架构的完整改造计划
- [Core 实施路线图](./plotgram-core-implementation-roadmap.md) - `plotgram-core` 重构的分阶段落地计划
...
如果您想为 Plotgram 贡献代码，请先阅读：
1. [整体架构](./overview.md) - 理解项目结构
2. [设计哲学](./design-philosophy.md) - 遵循设计原则
3. [Core 重构方案](./plotgram-core-refactor-plan.md) - 了解核心模块的演进方向
4. [Core 实施路线图](./plotgram-core-implementation-roadmap.md) - 了解分阶段改造步骤

## 相关代码

- [plotgram-core](../../crates/plotgram-core/src/lib.rs)
- [plotgram-wasm](../../crates/plotgram-wasm/src/lib.rs)
