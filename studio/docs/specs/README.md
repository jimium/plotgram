...
Plotgram Studio 前端模块的接口与协议规范。

> 注意：Plotgram DSL 语言规范、AST 规范、Pipeline 规范等核心规范在项目根目录 `docs/specs/` 中，此处仅存放 Studio 前端自身的接口规范。
...
| WASM 桥接层接口 | Studio 与 plotgram-wasm 的 TypeScript 接口定义 |
