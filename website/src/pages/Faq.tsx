...
export default function Faq() {
  return (
    <DocPage
      title="❓ 常见问题"
      description="关于 Plotgram 最常被问到的问题。"
      sidebar={sidebar}
    >
      <h2>基础问题</h2>
      ...
      <div className="faq-list">
        ...
        <div className="faq-item">
          ...
          <p>可以。Plotgram 提供单二进制的 CLI 工具和 HTTP API 服务，部署非常简单。HTTP 服务只需要一个二进制文件，不依赖数据库或其他服务。</p>
        </div>
        <div className="faq-item">
      ...
      <div className="faq-list">
        <div className="faq-item">
          <h3><span className="q">Q</span>我的 LLM 应用如何集成 Plotgram？</h3>
        ...
        <div className="faq-item">
          ...
          <p>Plotgram 的 validate API 返回结构化 JSON 错误（含错误码、行列位置、上下文、修复建议）。Agent 可以将错误信息加入上下文中重试，实践中 90%+ 的错误一次重试即可修复。建议最多重试 2 次。</p>
        </div>
        <div className="faq-item">
      ...
      <div className="faq-list">
        ...
        <div className="faq-item">
          ...
          <p>Plot（绘图/情节）+ gram（书写/记录）。既表达了「绘制图表」的功能，也暗合「情节/逻辑的结构化表达」——Plotgram 的布局引擎不仅是画图形，更是在梳理和呈现逻辑关系。</p>
        </div>
      </div>
    </DocPage>
  );
