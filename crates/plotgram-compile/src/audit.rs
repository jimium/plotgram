...
fn count_node_overlaps(nodes: &[plotgram_model::result::NodePlacement]) -> u32 {
    let mut count = 0u32;
...
fn count_label_overlaps(labels: &[plotgram_model::result::LabelSlot]) -> u32 {
    let mut count = 0u32;
...
fn total_edge_length(edges: &[plotgram_model::result::EdgePlacement]) -> f64 {
