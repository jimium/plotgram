...
impl EvalEngine {
    ...
    pub fn evaluate_combinations(
        ...
        let layout_names = plotgram_core::layout::applicable_layouts_for_type(diagram_type);
        let routing_names = plotgram_core::layout::applicable_routings_for_type(diagram_type);
...
pub mod presets {
    ...
    use plotgram_core::ast::{AttributeValue, Diagram, DiagramAttribute, TextValue};
    use plotgram_core::types::DiagramType;
        ...
        AlgorithmConfig {
            ...
            modifier: Box::new(move |diag: &mut Diagram| {
                ...
                diag.attributes.push(DiagramAttribute {
                    ...
                    span: plotgram_core::ast::Span::dummy(),
                });
            }),
        }
    }
    ...
    pub fn layout_algos_for_type(diagram_type: &DiagramType) -> Vec<AlgorithmConfig> {
        plotgram_core::layout::applicable_layouts_for_type(diagram_type)
            .iter()
    ...
    pub fn routing_algos_for_type(diagram_type: &DiagramType) -> Vec<AlgorithmConfig> {
        plotgram_core::layout::applicable_routings_for_type(diagram_type)
            .iter()
