//! Tautcore SVG renderer.
//!
//! Entry points: [`render_svg`] (SVG backend) and [`render_ascii`] (Unicode
//! text backend). Both consume [`tautcore_model::render::RenderInput`]
...
mod tests {
    ...
    use tautcore_model::result::{EdgePath, EdgePlacement, LayoutResult, NodePlacement};
    ...
    fn node_icon_is_rendered_from_explicit_attr() {
        use tautcore_model::attr::AttrValue;
        use tautcore_model::result::{LabelOwner, LabelSlot};
    ...
    fn edge_and_group_inline_styles() {
        ...
        use tautcore_model::result::GroupPlacement;
