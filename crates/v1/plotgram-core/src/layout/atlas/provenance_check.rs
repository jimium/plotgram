...
mod tests {
    ...
    fn product_flowchart_channel_provenance_full() {
        let cases = [
            include_str!("../../../../../showcase/flowchart/product.linear-chain.pgm"),
            include_str!("../../../../../showcase/flowchart/product.user-auth.pgm"),
            include_str!("../../../../../showcase/flowchart/product.password-reset.pgm"),
            include_str!("../../../../../showcase/flowchart/product.symmetric-fanout.pgm"),
            include_str!("../../../../../showcase/flowchart/product.self-loop-retry.pgm"),
        ];
        for source in cases {
    ...
    fn product_flowchart_no_group_penetration() {
        let cases = [
            include_str!("../../../../../showcase/flowchart/product.linear-chain.pgm"),
            include_str!("../../../../../showcase/flowchart/product.user-auth.pgm"),
            include_str!("../../../../../showcase/flowchart/product.refund-process.pgm"),
            include_str!("../../../../../showcase/flowchart/product.swimlane-order-process.pgm"),
            include_str!("../../../../../showcase/flowchart/product.leave-approval-process.pgm"),
        ];
    ...
    fn product_post_ink_no_group_penetration_lint() {
        ...
        let cases = [
            ...
            include_str!("../../../../../showcase/flowchart/product.user-auth.pgm"),
            include_str!("../../../../../showcase/flowchart/product.swimlane-order-process.pgm"),
            include_str!("../../../../../showcase/architecture/product.ecommerce-platform.pgm"),
