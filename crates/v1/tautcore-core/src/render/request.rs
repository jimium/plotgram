...
use crate::error::{TautcoreError, Result};
...
pub struct RenderRequest<'a> {
    ...
    pub dark_mode: bool,
    /// 是否在 SVG 右下角输出 "by Tautcore" 署名（默认开启）。
