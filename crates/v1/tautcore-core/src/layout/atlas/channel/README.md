...
> Stage 7 后为默认）。设计出处：[22 号文 §5.1 I.6](../../../../../../docs/altlas/22-Atlas下一代布局与路由架构-总纲-2026-07.md)；
> 推进：[23 号文](../../../../../../docs/altlas/23-Atlas分阶段推进方案-2026-07.md)。
>
...
1. **穿组不可表达（H2，[27 号文](../../../../../../docs/altlas/27-Atlas-channel模块审查与改造需求-2026-07.md) L1/L8/L6 三道防线）**
...
| 步骤 | 内容 |
|---|---|
| **端口挂接增强**（已完成） | [24 号文](../../../../../../docs/altlas/24-Atlas-channel端口挂接与候选端点增强需求-2026-07.md) R1–R5：PortSlot 带 `(node,side,slot_index)`、`resolve_host_track` / `derive_node_ports` 按侧挂接、`route_candidates` / `route_node_sides`（**不含**完整 I.5 侧决策） |
