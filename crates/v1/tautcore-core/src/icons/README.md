...
> 实现模块：`crates/tautcore-core/src/icons/`（模块已就绪，待 `lib.rs` 接入）
...
```bash
python3 crates/tautcore-core/src/icons/assets/glyphs/generate_index.py
```
