...
use tautcore_core::layout::{compute_layout_with_plan, LayoutResult};
// 与 core 对齐:使用 WASM-safe 的 perf::Instant(eval 本身为 native-only 工具,
// 不会编译到 wasm32,但统一引用路径便于跨 crate 维护)
use tautcore_core::layout::perf::Instant;
use tautcore_core::layout::pipeline::plan::LayoutPlan;
use tautcore_core::profile::profile_for;
use std::sync::mpsc;
...
impl EvalEngine {
    ...
    pub fn evaluate_combinations(
        ...
        let layout_names = tautcore_core::layout::applicable_layouts_for_type(diagram_type);
        let routing_names = tautcore_core::layout::applicable_routings_for_type(diagram_type);
...
pub mod presets {
    ...
    use tautcore_core::ast::{AttributeValue, Diagram, DiagramAttribute, TextValue};
    use tautcore_core::types::DiagramType;
        ...
        AlgorithmConfig {
            ...
            modifier: Box::new(move |diag: &mut Diagram| {
                ...
                diag.attributes.push(DiagramAttribute {
                    ...
                    span: tautcore_core::ast::Span::dummy(),
                });
            }),
        }
    }
    ...
    pub fn layout_algos_for_type(diagram_type: &DiagramType) -> Vec<AlgorithmConfig> {
        tautcore_core::layout::applicable_layouts_for_type(diagram_type)
            .iter()
    ...
    pub fn routing_algos_for_type(diagram_type: &DiagramType) -> Vec<AlgorithmConfig> {
        tautcore_core::layout::applicable_routings_for_type(diagram_type)
            .iter()
