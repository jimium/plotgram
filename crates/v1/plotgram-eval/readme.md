# plotgram-eval — Plotgram 布局与边路由算法评估框架
...
# 布局+路由组合评估
plotgram-eval eval flowchart.pgm -c combinations

# 批量评估目录
plotgram-eval batch showcase/

# 按图类型权重评估
plotgram-eval batch showcase/ -w per-type

# 与基线对比
plotgram-eval batch showcase/ --baseline .eval-history/baseline.json

# 保存历史
plotgram-eval batch showcase/ --save-history
