...
use tautcore_model::graph::{Edge, Graph, Group, Node, NodeRole};
use tautcore_model::port::{PortConstraint, Side};
use tautcore_model::profile::{DiagramType, Profile};
...
fn expand_archetypes_in_nodes(nodes: &mut [Node]) {
    use tautcore_model::archetype::archetype_by_id;
