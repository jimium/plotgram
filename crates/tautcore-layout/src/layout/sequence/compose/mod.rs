...
use tautcore_algo::linear_arrange::{arrange, LinearArrangeMethod, LinearArrangement};
use tautcore_engine_api::LayoutError;
use tautcore_model::graph::{Arrow, Graph, NodeRole};
...
fn parse_pin(
    raw: &tautcore_model::attr::AttrValue,
    n: usize,
    id: &str,
