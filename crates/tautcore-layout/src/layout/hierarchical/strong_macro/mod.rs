...
use tautcore_algo::orientation::{self as algo_orient, Size};
use tautcore_engine_api::{LayoutError, LayoutInput};
use tautcore_model::geometry::Rect;
use tautcore_model::graph::Group;
...
pub(super) fn layout(
    ...
    (
        ...
        Vec<BundlePlan>,
        Vec<tautcore_model::geometry::Rect>,
        Vec<tautcore_model::result::GroupPlacement>,
        BTreeSet<String>,
    ),
    LayoutError,
> {
...
fn group_placements_from_blocks(blocks: &[Block]) -> Vec<tautcore_model::result::GroupPlacement> {
    blocks
        .iter()
        .filter_map(|b| {
            ...
            Some(tautcore_model::result::GroupPlacement {
                id: id.clone(),
...
mod tests {
    ...
    use tautcore_engine_api::{EdgeGeometryMode, LayoutAlgorithm};
    use tautcore_model::attr::{AttrMap, AttrValue};
    use tautcore_model::geometry::Size;
    use tautcore_model::graph::{Arrow, Edge, Graph, Node, NodeRole};
    ...
    fn layout_strong(graph: &Graph, sizes: &NodeSizes) -> tautcore_engine_api::LayoutOutput {
    ...
    fn layout_strong_with(
        ...
        sizes: &NodeSizes,
        options: &AttrMap,
    ) -> tautcore_engine_api::LayoutOutput {
        HierarchicalLayout
            .layout(LayoutInput {
                graph,
                node_sizes: sizes,
    ...
    fn frame_center(out: &tautcore_engine_api::LayoutOutput, id: &str) -> (f64, f64) {
    ...
    fn three_group_chain_stacks_vertically_centered_and_disjoint() {
        ...
        let frame_of: BTreeMap<&str, tautcore_model::geometry::Rect> =
