//! Bridge between `plotgram_model`'s physical-frame geometry types and
//! `plotgram_algo::orientation`'s canonical-TB transform types.
//!
...
use plotgram_algo::orientation as algo;
