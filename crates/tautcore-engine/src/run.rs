...
use tautcore_model::contract::LayoutContract;
use tautcore_model::diagnostics::LayoutWarning;
use tautcore_model::result::{EdgePlacement, LayoutResult, NodePlacement};

use crate::finalize::finalize;
use crate::registry::Registry;
use tautcore_router::core::port_anchor;
...
mod tests {
    ...
    fn hierarchical_with_independent_curved_router() {
        ...
        assert!(matches!(
            result.edges[0].path,
            tautcore_model::result::EdgePath::Cubic { .. }
                | tautcore_model::result::EdgePath::Polyline { .. }
        ));
    }
