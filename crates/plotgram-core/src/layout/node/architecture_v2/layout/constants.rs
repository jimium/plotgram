...
pub(in super::super) const LAYER_GAP: f64 = 72.0;
pub(in super::super) const MIN_GROUP_GAP: f64 = 8.0;
pub(in super::super) const NODE_GAP: f64 = 32.0;
pub(in super::super) const GROUP_GAP_X: f64 = 40.0;
pub(in super::super) const INTRA_LAYER_GAP: f64 = 40.0;
