...
pub(in crate::layout::node) struct BuildOutput {
...
pub(in crate::layout::node) fn build_coordinate_problem(
...
pub(in crate::layout::node) fn build_with_mapping(
    layered_graph: &DiGraph<LayerNode, ()>,
    layers: &[Vec<NodeIndex>],
    sizes: &HashMap<NodeIndex, (f64, f64)>,
    centers: &HashMap<NodeIndex, f64>,
...
pub(in crate::layout::node) fn extract_centers(
    problem: &CoordinateProblem,
    coords: &[f64],
    layered_graph: &DiGraph<LayerNode, ()>,
    layers: &[Vec<NodeIndex>],
