//! Independent polyline [`EdgeRouter`](plotgram_engine_api::EdgeRouter).
//!
...
use plotgram_engine_api::{EdgeRouter, LayoutError, RouteScene, TerminalPair};
...
mod tests {
    use super::*;
    use plotgram_engine_api::{GroupBoundary, Obstacle, OrthogonalRouteParams, PortAnchor};
