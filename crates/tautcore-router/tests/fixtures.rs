...
//!
//! Scenes live as JSON in `tests/scenes/*.json` (see [`tautcore_router::fixture`]).
//! Tests load all scenes, filter by capability level, and verify invariants.

use std::path::PathBuf;

use tautcore_engine_api::{EdgeRouter, LayoutError};
use tautcore_router::fixture::{load_dir, Requires, RouteExpect, SceneFixture};
use tautcore_router::verify::{verify_all, verify_determinism};
use tautcore_router::OrthogonalEdgeRouter;
