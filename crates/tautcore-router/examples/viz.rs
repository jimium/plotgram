...
//!
//! Run: `cargo run -p tautcore-router --example viz -- orthogonal`
...
use tautcore_engine_api::EdgeRouter;
use tautcore_model::geometry::Rect;
use tautcore_model::result::{EdgePath, EdgePlacement};
use tautcore_router::fixture::{load_dir_board, BoardFixture, RouteExpect, SceneFixture};
use tautcore_router::verify::verify_all;
use tautcore_router::{
...
<head>
<meta charset="utf-8"/>
<title>tautcore-router · {algo_name}</title>
<style>
...
<body>
<h1>tautcore-router · {algo_name}</h1>
