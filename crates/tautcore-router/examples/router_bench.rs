...
//!
//! Run: `cargo run -p tautcore-router --example router_bench -- orthogonal`
//!
...
use tautcore_router::fixture::{load_dir, Requires, SceneFixture};
use tautcore_router::score::{score_scene, SceneScore};
