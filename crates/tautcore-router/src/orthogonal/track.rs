...
use tautcore_engine_api::RouteScene;
...
mod tests {
    ...
    fn fanout_e2_merges_return_connector() {
        use tautcore_engine_api::{EdgeRouter, Obstacle, PortAnchor, TerminalPair};
        ...
        let scene = tautcore_engine_api::RouteScene {
            obstacles: vec![
    ...
    fn invert_paths_separate_without_crossing() {
        use tautcore_engine_api::{OrthogonalRouteParams, PortAnchor, TerminalPair};
        use tautcore_model::port::Side;
