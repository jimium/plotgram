//! Independent orthogonal [`EdgeRouter`](tautcore_engine_api::EdgeRouter).
//!
...
//! L4 VPSC nudging (see `nudge.rs`, `tautcore_algo::{interval_color,vpsc}`).
...
use tautcore_model::port::PortRef;
...
mod tests {
    use super::*;
    use tautcore_engine_api::{GroupBoundary, Obstacle, PortAnchor};
