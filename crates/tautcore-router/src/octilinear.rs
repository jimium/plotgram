//! Independent octilinear [`EdgeRouter`](tautcore_engine_api::EdgeRouter).
//!
...
use tautcore_engine_api::{EdgeRouter, LayoutError, Obstacle, RouteScene, TerminalPair};
...
mod tests {
    use super::*;
    use tautcore_engine_api::{GroupBoundary, OrthogonalRouteParams, PortAnchor};
