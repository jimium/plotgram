...
| 位置 | 范围 |
|------|------|
| `docs/specs/` | Tautcore DSL 语言规范、AST 规范、Pipeline 规范（核心，跨项目） |
| `docs/architecture/` | tautcore-core 渲染引擎架构、算法、WASM 模块（后端） |
| `docs/product/` | 产品愿景、竞品分析、路线图（产品） |
| `studio/docs/` | Tautcore Studio 前端应用专属文档（本目录） |
